" tests/vim_spec/symbols_mode_spec.vim — Pure VimScript tests for nam#symbols_mode#*
"
...
let s:mode = nam#symbols_mode#Create({})
...
call nam#symbols_mode#Refresh()
let s:render_result = nam#symbols_mode#RenderSym()
...
call g:AssertEquals(nam#symbols_mode#SelectSym('nonexistent'), v:null, 'unknown label returns v:null')
