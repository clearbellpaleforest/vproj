" tests/vim_spec/labels_spec.vim — Pure VimScript tests for nam#labels#*

let g:CurrentTest = 'labels: generate 10 single-char labels'
let s:tiers = ['1234567890', 'asdfghjkl', 'qwertyuiop', 'zxcvbnm']
let result = nam#labels#Generate(10, s:tiers, 'double')
...
let result = nam#labels#Generate(36, s:tiers, 'double')
...
let result = nam#labels#Generate(37, s:tiers, 'double')
...
let result = nam#labels#BuildMap(items)
