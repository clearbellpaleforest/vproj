" tests/vim_spec/files_mode_spec.vim — Pure VimScript tests for vproj#files_mode#*

let g:CurrentTest = 'files_mode: Create returns mode dict with name/key/icon'
let mode = vproj#files_mode#Create({})
...
call g:AssertFalse(vproj#files_mode#PrevPage(), 'PrevPage at page 0 should return false')

let g:CurrentTest = 'files_mode: NextPage with TotalPages=1 returns false'
call g:AssertFalse(vproj#files_mode#NextPage(), 'NextPage with TotalPages=1 should return false')

let g:CurrentTest = 'files_mode: SelectFile with unknown label returns v:null'
call g:AssertEquals(vproj#files_mode#SelectFile('zz'), v:null, 'SelectFile with unknown label should return v:null')
