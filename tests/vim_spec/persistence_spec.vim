...
let result = nam#persistence#Save('')
call g:AssertTrue(result, 'Save returned true')
call nam#persistence#Clear('')

let g:CurrentTest = 'persistence: Restore with nonexistent session returns false'
let result = nam#persistence#Restore('/nonexistent/nam/testing/unused')
