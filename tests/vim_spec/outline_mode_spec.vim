" tests/vim_spec/outline_mode_spec.vim -- Pure VimScript tests for vproj#outline_mode#*
"
...
let s:mode = vproj#outline_mode#Create({})
...
let s:ok = v:true
try
  call vproj#outline_mode#Refresh()
catch
  let s:ok = v:false
endtry
...
let s:result = vproj#outline_mode#RenderOut()
...
let s:rv = vproj#outline_mode#SelectOut('ZZ_NONEXISTENT')
...
let s:rv = vproj#outline_mode#SelectOut('')
